# Traditional node group replaced by Karpenter NodePool
...
# NodePool not needed - EKS Auto Mode handles node management automatically
# resource "null_resource" "apply_nodepool" {
#   depends_on = [aws_eks_cluster.this]
#   
#   provisioner "local-exec" {
#     command = "kubectl apply -f ${path.module}/eks.node-pool.yaml"
#   }
# }